...
<div class="container text-right">
  <a href="<?php echo base_url('admin/merchandise/gambar/'.$gambar->id_merchandise) ?>" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
</div>
<hr>
<?php 
$last_num = $this->merchant_model->get_last_num_image($gambar->id_merchandise);
echo form_open_multipart(base_url('admin/merchandise/edit_gambar/'.$gambar->id_gambar_merchandise),'id="tambah"') ?>
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      ...
      <img src="<?php echo base_url('assets/img/merchant/'.$gambar->gambar) ?>" style="max-width:200px; height:auto;">
    </div>
  </div>
