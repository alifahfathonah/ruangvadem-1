...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <img src="<?php echo base_url('assets/img/'.$site->icon) ?>" style="max-width:200px; height:auto;">
    </div>
    
    <div class="col-md-12">
	<input type="submit" name="submit" value="Save new icon" class="btn btn-primary">
    <input type="reset" name="reset" value="Reset" class="btn btn-primary" onclick="reset_klik()">
</div>
</div>
</form>