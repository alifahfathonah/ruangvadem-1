...
echo form_open_multipart(base_url('admin/project/tambah'),'id="tambah"') ?>

  <div class="row">
    <div class="col-md-6">
      <div class="form-group has-error">
        <label class="text-danger">Judul Project <span class="text-danger">*</span></label>
        <input type="text" name="judul" id="judul" class="form-control" placeholder="judul project" value="<?php echo set_value('judul') ?>">
      </div>

      <div class="form-group has-error">
        <label class="text-danger">Tahun <span class="text-danger">*</span></label>
        <input type="number" name="tahun" id="tahun" class="form-control" placeholder="tahun project" value="<?php echo set_value('tahun') ?>">
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <textarea id="isi" name="deskripsi" class="form-control"><?php echo set_value('deskripsi') ?></textarea>
      </div>
