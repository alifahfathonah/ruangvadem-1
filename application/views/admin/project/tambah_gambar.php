...
<div class="container text-right">
  <a href="<?php echo base_url('admin/project/gambar/'.$id_project) ?>" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
</div>
<hr>

<?php 
$last_num = $this->project_model->get_last_num_image($id_project);
echo form_open_multipart(base_url('admin/project/tambah_gambar/'.$id_project),'id="tambah"') ?>
